...
export default function Farm() {
  ...
  return (
    <StargateLayout>
      <div className="max-w-6xl overflow-auto z-20 mt-12 px-4 mx-auto">
        <h1 className="text-4xl font-bold mb-4">
          <span className="text-[#999999]">Stargate</span> Farm
        </h1>
        <p className="text-gray-400 mt-8 mb-8">
          Stargate liquidity providers can farm their LP tokens in exchange for
          STG rewards. <br /> Earn STG and become a member of the Stargate
          community.
        </p>
          ...
          <div className="bg-[#232323] z-20 rounded-lg p-4 flex text-sm justify-between items-center mb-4">
            <div className="flex gap-4 items-center z-20">
              ...
              <div className="px-3 md:block hidden py-1 rounded-lg border border-[#50BEAF]">
                Top Farms • <span className="text-[#50BEAF]">82</span>
              </div>
              <div className="px-3 md:block hidden py-1 opacity-30 rounded-lg border border-[#eaeaea]/20">
                Pending Rewards • 0
              </div>
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-4 mb-2">
            {poolData.map((pool, index) => (
              <div key={index} className="bg-[#232323]  rounded-lg  p-4">
                ...
                <div className="text-sm mt-3 flex items-center justify-between text-gray-400">
                  <div>LTP Available To Stake</div>
                  <div>Liquidity</div>
          ...
          <div className="flex z-40 justify-end mb-10 items-center">
            {/* <div>
              ...
              <tbody>
                {currentItems.map((pool, index) => (
                  <tr key={index} className="border-t py-8 border-black">
                    ...
                    <td className="py-5 px-2">{pool.apy}</td>
                  </tr>
                ))}
              </tbody>
            </table>
