...
export const gravityTokens: ITokens[] = [
  {
    name: "Wrapped BTC",
  ...
  //   {
  //     name: "Staked USDe",
  //     address: "0xB524268D917a7eCCb6cce6bC563CcfD80146F103",
  //     symbol: "sUSDe",
  //     decimals: 18,
  //     chainId: 1625,
  //     logoURI:
  ...
  //     chainId: 1625,
  //     logoURI:
  //       "https://raw.githubusercontent.com/latchwallet/latch-token-list/master/logo/atUSD.svg",
  //   },
  {
    ...
    chainId: 1625,
    logoURI:
      "https://raw.githubusercontent.com/latchwallet/latch-token-list/master/logo/atETH.svg",
  },
  {
    name: "Wrapped G",
